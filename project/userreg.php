...
if(isset($_POST['Submit']))
  {
    ...
    $ret=mysqli_query($con, "select username from user where username='$user' || contact='$contno'");
...
echo "<script>window.location.href ='userreg.php'</script>";
    ...
    $query=mysqli_query($con, "insert into user(userid,username,Password,contact,loc) values('','$user','$pass','$contno','$loc');");
    if ($query) {
