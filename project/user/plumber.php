            ...
            <div class="container-fluid px-4">
                ...
                <div class="row my-5">
                    ...
                    <div class="col">
                        ...
                        $query="select * from handyman where handymanprofession = 'plumber' ";
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><?php echo$row['handymanname']; ?></td>
                                    <td><?php echo$row['handymancontact']; ?></td>
                                    <td><?php echo$row['handymanwage']; ?></td>
                                    <td><?php echo$row['handymanimage']; ?></td>
                                </tr>
                                <?php 
